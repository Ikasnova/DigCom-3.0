...
const RAW_OUTCOMES: string[][] = [
  ...
  ['LO1.1.02', 'Recognise that the results or outputs of a search depend on the digital search tool used and the way that an individual specifies the search.', 'Reconocer que los resultados de una búsqueda dependen de la herramienta de búsqueda digital utilizada y de la forma en que un individuo especifica la búsqueda.', 'Basic', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO1.1.05', 'Use digital search tools to implement basic information searches.', 'Utilizar herramientas de búsqueda digital para implementar búsquedas de información básica.', 'Basic', 'Skill', 'AI-Implicit'],
  ...
  ['LO1.1.10', 'Select appropriate digital search tools based on information needs.', 'Seleccionar herramientas de búsqueda digital apropiadas basadas en las necesidades de información.', 'Intermediate', 'Skill', 'AI-Implicit'],
  ...
  ['LO1.1.14', 'Prioritise deepening one’s existing search capabilities.', 'Priorizar la profundización de las capacidades de búsqueda existentes de uno mismo.', 'Advanced', 'Attitude', 'AI-Implicit'],
  ...
  ['LO1.2.05', 'Recognise examples of misinformation, disinformation, and sources of bias.', 'Reconocer ejemplos de información errónea, desinformación y fuentes de sesgo.', 'Basic', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO1.2.09', 'Recognise potential consequences of misinformation and disinformation in digital environments for oneself and others.', 'Reconocer las posibles consecuencias de la información errónea y la desinformación en entornos digitales para uno mismo y para los demás.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO1.2.13', 'Recognise that the data used to train AI systems and how they are trained affects the reliability of the information they provide.', 'Reconocer que los datos utilizados para entrenar sistemas de IA y cómo son entrenados afecta la fiabilidad de la información que proporcionan.', 'Intermediate', 'Knowledge', 'AI-Explicit'],
  ...
  ['LO1.2.18', 'Recognise the presence of user-directing strategies in digital environments such as clickbait, nudging and gamification.', 'Reconocer la presencia de estrategias dirigidas al usuario en entornos digitales como clickbait, nudging y gamificación.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO1.2.23', 'Describe personal, social and political consequences of misinformation, disinformation, sources of bias, social media influencing and filter bubbles.', 'Describir consecuencias personales, sociales y políticas de la información errónea, desinformación, fuentes de sesgo, influencia en redes sociales y burbujas de filtro.', 'Advanced', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO1.3.21', 'Take account of potential sources of error or inaccuracy in management and processing of data and information in digital environments.', 'Tener en cuenta las posibles fuentes de error o inexactitud en la gestión y el procesamiento de datos e información en entornos digitales.', 'Advanced', 'Attitude', 'AI-Implicit'],
  ...
  ['LO1.3.28', 'Apply appropriate analysis of information and data in digital environments to contribute to complex decision-making.', 'Aplicar un análisis apropiado de información y datos en entornos digitales para contribuir a la toma de decisiones complejas.', 'Advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO1.3.34', 'Lead or contribute to initiatives that support others in advanced information and data management, processing and analysis in digital environments.', 'Liderar o contribuir a iniciativas que apoyen a otros en la gestión, procesamiento y análisis avanzados de información y datos en entornos digitales.', 'Highly advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO2.1.18', 'Recognise that robots can operate with varying degrees of autonomy.', 'Reconocer que los robots pueden operar con diferentes grados de autonomía.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO2.1.25', 'Assess benefits and disadvantages of robotic applications in a specific context.', 'Evaluar beneficios y desventajas de las aplicaciones robóticas en un contexto específico.', 'Advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO2.2.05', 'Recognise that information and content - not all of which is true or accurate - can be shared in a variety of ways by AI systems as well as humans.', 'Reconocer que la información y el contenido - no todo lo cual es verdadero o exacto - puede ser compartido de diversas maneras tanto por sistemas de IA como por humanos.', 'Basic', 'Knowledge', 'AI-Explicit'],
  ['LO2.2.06', 'Identify purpose and target audience of information and content to be shared in digital environments.', 'Identificar el propósito y la audiencia objetivo de la información y el contenido a compartir en entornos digitales.', 'Basic', 'Knowledge', 'AI not Implicit or Explicit'],
  ['LO2.2.07', 'Use simple processes to share information and content in digital environments appropriately and in accordance with goals.', 'Utilizar procesos simples para compartir información y contenido en entornos digitales de manera apropiada y de acuerdo con los objetivos.', 'Basic', 'Skill', 'AI not Implicit or Explicit'],
  ...
  ['LO2.2.13', 'Report or flag misinformation and disinformation that has been shared in digital environments.', 'Reportar o marcar información errónea y desinformación que ha sido compartida en entornos digitales.', 'Intermediate', 'Skill', 'AI-Implicit'],
  ...
  ['LO2.2.15', 'Effectively and ethically share information and content in digital environments to support personal, learning or professional goals of oneself and others.', 'Compartir información y contenido de manera efectiva y ética en entornos digitales para apoyar objetivos personales, de aprendizaje o profesionales propios y de otros.', 'Advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO2.2.17', 'Explore new and alternative means for complex sharing information and content in digital environments.', 'Explorar medios nuevos y alternativos para el intercambio complejo de información y contenido en entornos digitales.', 'Highly advanced', 'Attitude', 'AI-Implicit'],
  ...
  ['LO2.3.01', 'Acknowledge the potential benefits of digital technologies for one’s own and others empowerment and participation.', 'Reconocer los beneficios potenciales de las tecnologías digitales para el empoderamiento y participación propia y de los demás.', 'Basic', 'Attitude', 'AI not Implicit or Explicit'],
  ...
  ['LO2.3.06', 'Identify main purposes and functions of (personally relevant) digital platforms and services.', 'Identificar los propósitos y funciones principales de plataformas y servicios digitales (personalmente relevantes).', 'Basic', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO2.3.15', 'Recognise key freedoms, rights and responsibilities of individuals under relevant digital laws and regulations.', 'Reconocer libertades, derechos y responsabilidades clave de los individuos bajo leyes y regulaciones digitales relevantes.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO2.3.17', 'Describe the concept of the platform economy, including opportunities, risks, social and ethical implications.', 'Describir el concepto de economía de plataforma, incluidas oportunidades, riesgos, implicaciones sociales y éticas.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ['LO2.3.18', 'Describe the concept and functions of civic monitoring.', 'Describir el concepto y las funciones del monitoreo cívico.', 'Intermediate', 'Knowledge', 'AI not Implicit or Explicit'],
  ['LO2.3.19', 'Describe the concept and functions of e-Government.', 'Describir el concepto y las funciones del gobierno electrónico.', 'Intermediate', 'Knowledge', 'AI not Implicit or Explicit'],
  ...
  ['LO2.3.22', 'Assess opportunities, risks, social and ethical implications of the platform economy.', 'Evaluar oportunidades, riesgos e implicaciones sociales y éticas de la economía de plataforma.', 'Intermediate', 'Skill', 'AI-Implicit'],
  ...
  ['LO2.3.26', 'Describe potential societal, political or economic impacts of prohibited and high-risk AI systems.', 'Describir los posibles impactos sociales, políticos o económicos de los sistemas de IA prohibidos y de alto riesgo.', 'Advanced', 'Knowledge', 'AI-Explicit'],
  ...
  ['LO2.3.28', 'Assess a range of ways in which digital technologies such as social media platforms can influence democratic processes.', 'Evaluar una variedad de formas en que las tecnologías digitales, como las plataformas de redes sociales, pueden influir en los procesos democráticos.', 'Advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO2.3.31', 'Stay informed about individuals’ freedoms, rights and responsibilities with evolving digital technologies and legislative developments.', 'Mantenerse informado sobre las libertades, derechos y responsabilidades de los individuos con las tecnologías digitales en evolución y los desarrollos legislativos.', 'Highly advanced', 'Attitude', 'AI-Implicit'],
  ['LO2.3.32', 'Evaluate multiple impacts of digital technologies on society, political processes or the economy from a range of perspectives.', 'Evaluar múltiples impactos de las tecnologías digitales en la sociedad, los procesos políticos o la economía desde una variedad de perspectivas.', 'Highly advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO2.3.34', 'Lead or design digital citizenship initiatives, for example to promote participation, inclusion or empowerment.', 'Liderar o diseñar iniciativas de ciudadanía digital, por ejemplo, para promover la participación, la inclusión o el empoderamiento.', 'Highly advanced', 'Skill', 'AI-Implicit'],
  
  // 2.4 Collaborating through digital technologies
  ['LO2.4.01', 'Acknowledge the importance of effective communication skills for successful collaboration in digital environments.', 'Reconocer la importancia de las habilidades de comunicación efectiva para una colaboración exitosa en entornos digitales.', 'Basic', 'Attitude', 'AI not Implicit or Explicit'],
  ['LO2.4.02', 'Recognise main benefits and limitations of digital collaboration tools.', 'Reconocer los principales beneficios y limitaciones de las herramientas de colaboración digital.', 'Basic', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO2.4.06', 'Identify main features and functions of a variety of digital collaboration tools.', 'Identificar las características y funciones principales de una variedad de herramientas de colaboración digital.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO2.4.12', 'Prioritise a good fit between how digital collaboration tools are used and the preferences of individuals involved in collaboration.', 'Priorizar un buen ajuste entre cómo se utilizan las herramientas de colaboración digital y las preferencias de las personas involucradas en la colaboración.', 'Advanced', 'Attitude', 'AI-Implicit'],
  ['LO2.4.13', 'Ensure appropriate and ethical use of digital technologies including AI systems for collaborative tasks.', 'Asegurar el uso apropiado y ético de las tecnologías digitales, incluidos los sistemas de IA, para tareas colaborativas.', 'Advanced', 'Attitude', 'AI-Explicit'],
  ...
  ['LO2.4.16', 'Assess ethical and practical aspects of human-AI collaboration techniques for a given purpose.', 'Evaluar aspectos éticos y prácticos de las técnicas de colaboración humano-IA para un propósito dado.', 'Advanced', 'Skill', 'AI-Explicit'],
  ...
  ['LO2.4.19', 'Promote and support proportionate, ethical and effective use of digital technologies, including AI systems, in collaborations.', 'Promover y apoyar el uso proporcionado, ético y efectivo de las tecnologías digitales, incluidos los sistemas de IA, en colaboraciones.', 'Highly advanced', 'Attitude', 'AI-Explicit'],
  ...
  // 2.5 Netiquette
  ['LO2.5.01', 'Acknowledge the importance of giving space to the opinions of others in digital environments.', 'Reconocer la importancia de dar espacio a las opiniones de los demás en entornos digitales.', 'Basic', 'Attitude', 'AI not Implicit or Explicit'],
  ...
  ['LO2.5.04', 'Recognise that some behaviour in digital environments may not be acceptable to others, and/or may have legal consequences.', 'Reconocer que algunos comportamientos en entornos digitales pueden no ser aceptables para otros, y/o pueden tener consecuencias legales.', 'Basic', 'Knowledge', 'AI-Implicit'],
  ['LO2.5.05', 'Use appropriate tone and visual expression such as emoji in formal and non-formal digital environments.', 'Utilizar un tono y expresión visual apropiados, como emojis, en entornos digitales formales y no formales.', 'Basic', 'Skill', 'AI not Implicit or Explicit'],
  ...
  ['LO2.5.10', 'Use respectful and inclusive tone and visual expression such as emoji in formal and non-formal digital environments.', 'Utilizar un tono y expresión visual respetuosos e inclusivos, como emojis, en entornos digitales formales y no formales.', 'Intermediate', 'Skill', 'AI not Implicit or Explicit'],
  ['LO2.5.11', 'Promote and support inclusive and respectful behaviour in digital environments.', 'Promover y apoyar el comportamiento inclusivo y respetuoso en entornos digitales.', 'Advanced', 'Attitude', 'AI not Implicit or Explicit'],
  ...
  ['LO2.5.13', 'Identify types of abuse that can occur in digital environments, including affected groups and potential impacts.', 'Identificar tipos de abuso que pueden ocurrir en entornos digitales, incluidos los grupos afectados y los impactos potenciales.', 'Advanced', 'Knowledge', 'AI-Implicit'],
  ['LO2.5.14', 'Describe ways in which abuse in digital environments can be reported and tackled.', 'Describir formas en que se puede reportar y abordar el abuso en entornos digitales.', 'Advanced', 'Knowledge', 'AI-Implicit'],
  ['LO2.5.15', 'Respond with effective and respective communication and behaviour to difficult or complex situations in digital environments.', 'Responder con comunicación y comportamiento efectivos y respetuosos ante situaciones difíciles o complejas en entornos digitales.', 'Advanced', 'Skill', 'AI not Implicit or Explicit'],
  ...
  ['LO2.5.19', 'Stay informed about developments in policies and legislation relating to behaviour in digital environments.', 'Mantenerse informado sobre los desarrollos en políticas y legislación relacionadas con el comportamiento en entornos digitales.', 'Highly advanced', 'Attitude', 'AI-Implicit'],
  ['LO2.5.20', 'Assist others to understand key rights and responsibilities under policies and legislation relating to digital behaviour in a given context.', 'Ayudar a otros a comprender derechos y responsabilidades clave bajo políticas y legislación relacionadas con el comportamiento digital en un contexto dado.', 'Highly advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO2.6.07', 'Recognise the concept and components of a digital footprint.', 'Reconocer el concepto y los componentes de una huella digital.', 'Basic', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO2.6.14', 'Describe ways in which the scope of one’s digital identity can be analysed.', 'Describir formas en las que se puede analizar el alcance de la identidad digital de uno.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ['LO2.6.15', 'Identify features and functions used to manage digital identity, such as settings on devices and apps, online accounts, activity tracking and social media platforms.', 'Identificar características y funciones utilizadas para gestionar la identidad digital, como configuraciones en dispositivos y aplicaciones, cuentas en línea, seguimiento de actividad y plataformas de redes sociales.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ['LO2.6.16', 'Use information on the scope of one’s own digital identity to guide actions on digital identity management.', 'Utilizar información sobre el alcance de la propia identidad digital para guiar acciones sobre la gestión de la identidad digital.', 'Intermediate', 'Skill', 'AI-Implicit'],
  ['LO2.6.17', 'Adjust settings on devices and apps, online accounts and activity tracking to help manage one’s digital identity.', 'Ajustar configuraciones en dispositivos y aplicaciones, cuentas en línea y seguimiento de actividad para ayudar a gestionar la identidad digital de uno.', 'Intermediate', 'Skill', 'AI-Implicit'],
  ...
  ['LO2.6.19', 'Prioritise the assessment of one’s digital identity on an ongoing basis.', 'Priorizar la evaluación de la identidad digital de uno de forma continua.', 'Advanced', 'Attitude', 'AI-Implicit'],
  ['LO2.6.20', 'Recognise the relationship between digital technological developments and digital identity management.', 'Reconocer la relación entre desarrollos tecnológicos digitales y la gestión de la identidad digital.', 'Advanced', 'Knowledge', 'AI-Implicit'],
  ['LO2.6.21', 'Describe ways to exercise rights on issues relating to digital identity.', 'Describir formas de ejercer derechos sobre cuestiones relacionadas con la identidad digital.', 'Advanced', 'Knowledge', 'AI-Implicit'],
  ['LO2.6.22', 'Describe ways in which AI systems are used in digital identity management.', 'Describir formas en las que se utilizan los sistemas de IA en la gestión de la identidad digital.', 'Advanced', 'Knowledge', 'AI-Explicit'],
  ['LO2.6.23', 'Implement a variety of processes to manage digital identity across a range of digital environments.', 'Implementar una variedad de procesos para gestionar la identidad digital a través de una gama de entornos digitales.', 'Advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO2.6.25', 'Curate and manage digital identities for personal, professional and/or organisational purposes across a variety of platforms and services.', 'Curar y gestionar identidades digitales con fines personales, profesionales y/u organizacionales a través de una variedad de plataformas y servicios.', 'Advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO2.6.29', 'Advise others on complex aspects of digital identity management and rights.', 'Aconsejar a otros sobre aspectos complejos de la gestión de la identidad digital y los derechos.', 'Highly advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO3.1.06', 'Recognise that while AI systems can generate and integrate digital content, humans are essential to ensure ethical, responsible, and context-appropriate outputs.', 'Reconocer que, si bien los sistemas de IA pueden generar e integrar contenido digital, los humanos son esenciales para garantizar resultados éticos, responsables y apropiados para el contexto.', 'Basic', 'Knowledge', 'AI-Explicit'],
  ['LO3.1.07', 'Recognise that generative AI is a particular type of AI and is one of various digital technologies that can be used to support content creation.', 'Reconocer que la IA generativa es un tipo particular de IA y es una de las diversas tecnologías digitales que se pueden utilizar para apoyar la creación de contenido.', 'Basic', 'Knowledge', 'AI-Explicit'],
  ...
  ['LO3.1.09', 'Purposefully explore features and functions of digital content creation tools to deepen content creation capabilities.', 'Explorar intencionadamente características y funciones de herramientas de creación de contenido digital para profundizar las capacidades de creación de contenido.', 'Intermediate', 'Attitude', 'AI-Implicit'],
  ['LO3.1.10', 'Describe benefits, limitations and ethical considerations in the use of digital technologies such as AI systems for content creation.', 'Describir beneficios, limitaciones y consideraciones éticas en el uso de tecnologías digitales como los sistemas de IA para la creación de contenido.', 'Intermediate', 'Knowledge', 'AI-Explicit'],
  ['LO3.1.11', 'Define strategies such as templates or appropriate sequencing of steps that enable efficient digital content creation.', 'Definir estrategias como plantillas o secuenciación adecuada de pasos que permitan una creación eficiente de contenido digital.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO3.1.13', 'Assess inclusivity and/or accessibility needs of the audience for which digital content is being created.', 'Evaluar las necesidades de inclusión y/o accesibilidad de la audiencia para la que se está creando contenido digital.', 'Intermediate', 'Skill', 'AI not Implicit or Explicit'],
  ...
  ['LO3.1.15', 'Apply strategies such as templates or appropriate sequencing of steps that enable efficient digital content creation.', 'Aplicar estrategias como plantillas o secuenciación adecuada de pasos que permitan una creación eficiente de contenido digital.', 'Intermediate', 'Skill', 'AI-Implicit'],
  ...
  ['LO3.1.17', 'Acknowledge the importance of assessing capabilities, constraints and ethical aspects of digital content creation tools to ensure appropriate selection and use.', 'Reconocer la importancia de evaluar capacidades, limitaciones y aspectos éticos de las herramientas de creación de contenido digital para asegurar una selección y uso apropiados.', 'Advanced', 'Attitude', 'AI-Implicit'],
  ...
  ['LO3.1.19', 'Create and edit a variety of complex or specialised digital content, tailored appropriately to goals and audience.', 'Crear y editar una variedad de contenido digital complejo o especializado, adaptado adecuadamente a los objetivos y la audiencia.', 'Advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO3.2.08', 'Purposefully explore a variety of ways to integrate and re-elaborate digital content to deepen digital content integration and re-elaboration capabilities.', 'Explorar intencionadamente una variedad de formas de integrar y reelaborar contenido digital para profundizar las capacidades de integración y reelaboración de contenido digital.', 'Intermediate', 'Attitude', 'AI-Implicit'],
  ...
  ['LO3.2.12', 'Adjust or integrate digital content to meet format, structure and audience requirements.', 'Ajustar o integrar contenido digital para cumplir con los requisitos de formato, estructura y audiencia.', 'Intermediate', 'Skill', 'AI-Implicit'],
  ...
  ['LO3.2.16', 'Describe a range of methods for complex digital content integration and re-elaboration.', 'Describir una gama de métodos para la integración y reelaboración compleja de contenido digital.', 'Advanced', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO3.2.19', 'Apply digital technologies in a selective, ethical and transparent way to apply complex integration or re-elaboration to digital content.', 'Aplicar tecnologías digitales de manera selectiva, ética y transparente para aplicar integración o reelaboración compleja al contenido digital.', 'Advanced', 'Skill', 'AI-Implicit'],
  ['LO3.2.20', 'Support others to develop their capabilities in digital content integration and re-elaboration.', 'Apoyar a otros a desarrollar sus capacidades en la integración y reelaboración de contenido digital.', 'Advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO3.3.07', 'Use and share digital content in compliance with basic legal and ethical guidelines.', 'Utilizar y compartir contenido digital cumpliendo con pautas legales y éticas básicas.', 'Basic', 'Skill', 'AI-Implicit'],
  ...
  ['LO3.3.09', 'Acknowledge the complex nature of copyright and licensing of digital content.', 'Reconocer la naturaleza compleja de los derechos de autor y las licencias de contenido digital.', 'Intermediate', 'Attitude', 'AI-Implicit'],
  ...
  ['LO3.3.14', 'Identify examples of where copyright applies and does not apply in digital contexts.', 'Identificar ejemplos de dónde se aplican y no se aplican los derechos de autor en contextos digitales.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ['LO3.3.15', 'Describe legal, ethical and commercial consequences of intellectual property violations in digital contexts, including piracy and plagiarism.', 'Describir las consecuencias legales, éticas y comerciales de las violaciones de propiedad intelectual en contextos digitales, incluida la piratería y el plagio.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO3.3.17', 'Apply legal and ethical guidelines appropriately when using and sharing digital content.', 'Aplicar pautas legales y éticas de manera apropiada al usar y compartir contenido digital.', 'Intermediate', 'Skill', 'AI-Implicit'],
  ['LO3.3.18', 'Prioritise a consideration of ethical and legal aspects, such as transparency and copyright, when using and sharing digital content.', 'Priorizar una consideración de aspectos éticos y legales, como la transparencia y los derechos de autor, al usar y compartir contenido digital.', 'Advanced', 'Attitude', 'AI-Implicit'],
  ['LO3.3.19', 'Describe key features of current legislation in relation to digital copyright and licences.', 'Describir las características clave de la legislación actual en relación con los derechos de autor y licencias digitales.', 'Advanced', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO3.3.21', 'Identify differences in how ethical and copyright issues apply to training data for AI systems and AI-generated content (output).', 'Identificar diferencias en cómo se aplican las cuestiones éticas y de derechos de autor a los datos de entrenamiento para sistemas de IA y al contenido generado por IA (salida).', 'Advanced', 'Knowledge', 'AI-Explicit'],
  ['LO3.3.22', 'Assess and correctly apply legal and ethical guidelines for using and sharing of digital content in complex contexts, including different software licensing models and the renewal requirements of licences.', 'Evaluar y aplicar correctamente las pautas legales y éticas para el uso y el intercambio de contenido digital en contextos complejos, incluidos diferentes modelos de licencias de software y los requisitos de renovación de licencias.', 'Advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO3.3.24', 'Stay informed about developments in copyright and licensing regulations in digital contexts.', 'Mantenerse informado sobre los desarrollos en regulaciones de derechos de autor y licencias en contextos digitales.', 'Highly advanced', 'Attitude', 'AI-Implicit'],
  ['LO3.3.25', 'Promote and support awareness and understanding of legal and ethical copyright and licensing practices in digital contexts.', 'Promover y apoyar la conciencia y comprensión de las prácticas legales y éticas de derechos de autor y licencias en contextos digitales.', 'Highly advanced', 'Attitude', 'AI-Implicit'],
  ['LO3.3.26', 'Apply advanced knowledge of intellectual property rights, copyright and licensing concepts in digital contexts to inform decision-making.', 'Aplicar conocimientos avanzados de derechos de propiedad intelectual, derechos de autor y conceptos de licencias en contextos digitales para informar la toma de decisiones.', 'Highly advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO3.4.01', 'Acknowledge the essential role of humans in determining how computer programs and AI systems are used.', 'Reconocer el papel esencial de los humanos en la determinación de cómo se utilizan los programas informáticos y los sistemas de IA.', 'Basic', 'Attitude', 'AI-Explicit'],
  ...
  ['LO3.4.12', 'Recognise, with examples from computational thinking or programming, the concept of algorithm.', 'Reconocer, con ejemplos del pensamiento computacional o la programación, el concepto de algoritmo.', 'Intermediate', 'Knowledge', 'AI not Implicit or Explicit'],
  ...
  ['LO3.4.16', 'Define foundational programming concepts and general steps in programming.', 'Definir conceptos fundamentales de programación y pasos generales en la programación.', 'Intermediate', 'Knowledge', 'AI not Implicit or Explicit'],
  ...
  ['LO3.4.18', 'Recognise that machine learning is a branch of AI that enables algorithms to learn from data and make predictions.', 'Reconocer que el aprendizaje automático es una rama de la IA que permite a los algoritmos aprender de los datos y hacer predicciones.', 'Intermediate', 'Knowledge', 'AI-Explicit'],
  ...
  ['LO3.4.25', 'Acknowledge the importance of human oversight and human-centric approaches in the development and deployment of computer programs and AI systems.', 'Reconocer la importancia de la supervisión humana y los enfoques centrados en el ser humano en el desarrollo y despliegue de programas informáticos y sistemas de IA.', 'Advanced', 'Attitude', 'AI-Explicit'],
  ['LO3.4.26', 'Define the concepts and role of human-centric approaches and human oversight in the context of programming and AI systems.', 'Definir los conceptos y el papel de los enfoques centrados en el ser humano y la supervisión humana en el contexto de la programación y los sistemas de IA.', 'Advanced', 'Knowledge', 'AI-Explicit'],
  ...
  ['LO3.4.28', 'Distinguish between main types of machine learning.', 'Distinguir entre los principales tipos de aprendizaje automático.', 'Advanced', 'Knowledge', 'AI-Explicit'],
  ['LO3.4.29', 'Identify the main features and purposes of commonly-used machine learning algorithms.', 'Identificar las características y propósitos principales de los algoritmos de aprendizaje automático comúnmente utilizados.', 'Advanced', 'Knowledge', 'AI-Explicit'],
  ...
  ['LO3.4.31', 'Describe examples of the application of computational thinking and programming in robotics.', 'Describir ejemplos de la aplicación del pensamiento computacional y la programación en robótica.', 'Advanced', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO3.4.35', 'Apply programming tools or AI systems to complex computational thinking tasks.', 'Aplicar herramientas de programación o sistemas de IA a tareas de pensamiento computacional complejas.', 'Advanced', 'Skill', 'AI-Explicit'],
  ['LO3.4.36', 'Promote and support ethical programming and/or AI systems development practices.', 'Promover y apoyar prácticas éticas de programación y/o desarrollo de sistemas de IA.', 'Highly advanced', 'Attitude', 'AI-Explicit'],
  ['LO3.4.37', 'Stay informed about current developments in programming techniques and related applications of AI systems, such as robotics.', 'Mantenerse informado sobre los desarrollos actuales en técnicas de programación y aplicaciones relacionadas de sistemas de IA, como la robótica.', 'Highly advanced', 'Attitude', 'AI-Explicit'],
  ['LO3.4.38', 'Lead or contribute to complex projects focused on applications of computational thinking, programming or AI systems, including developing, validating and deploying computer programs or AI systems.', 'Liderar o contribuir a proyectos complejos centrados en aplicaciones de pensamiento computacional, programación o sistemas de IA, incluido el desarrollo, validación y despliegue de programas informáticos o sistemas de IA.', 'Highly advanced', 'Skill', 'AI-Explicit'],
  ...
  ['LO4.1.01', 'Acknowledge the importance of one’s individual role in protecting digital devices and their contents.', 'Reconocer la importancia del papel individual de uno en la protección de dispositivos digitales y sus contenidos.', 'Basic', 'Attitude', 'AI not Implicit or Explicit'],
  ...
  ['LO4.1.07', 'Acknowledge the importance of remaining vigilant to and up-to-date with cybersecurity practices.', 'Reconocer la importancia de mantenerse vigilante y actualizado con las prácticas de ciberseguridad.', 'Intermediate', 'Attitude', 'AI-Implicit'],
  ['LO4.1.08', 'Describe main features of malware.', 'Describir las características principales del malware.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO4.1.11', 'Prioritise regular checking and updating of cybersecurity measures that are in place on one’s devices.', 'Priorizar la revisión y actualización regular de las medidas de ciberseguridad que existen en los dispositivos de uno.', 'Advanced', 'Attitude', 'AI not Implicit or Explicit'],
  ['LO4.1.12', 'Describe key rights of individuals under current cybersecurity legislation.', 'Describir derechos clave de los individuos bajo la legislación de ciberseguridad actual.', 'Advanced', 'Knowledge', 'AI-Implicit'],
  ['LO4.1.13', 'Identify examples of how recent and emerging technologies such as AI systems are used in cyberattacks and cybersecurity.', 'Identificar ejemplos de cómo las tecnologías recientes y emergentes, como los sistemas de IA, se utilizan en ciberataques y ciberseguridad.', 'Advanced', 'Knowledge', 'AI-Explicit'],
  ['LO4.1.14', 'Update cybersecurity measures to protect devices and their contents in response to evolving digital threats.', 'Actualizar las medidas de ciberseguridad para proteger dispositivos y sus contenidos en respuesta a amenazas digitales en evolución.', 'Advanced', 'Skill', 'AI-Implicit'],
  ['LO4.1.15', 'Assist others in implementing basic device protection measures, such as antivirus software, screen locking, strong passwords and multi-factor authentication.', 'Ayudar a otros a implementar medidas básicas de protección de dispositivos, como software antivirus, bloqueo de pantalla, contraseñas seguras y autenticación multifactor.', 'Advanced', 'Skill', 'AI not Implicit or Explicit'],
  ...
  ['LO4.1.17', 'Assess rights of individuals under relevant provisions of current cybersecurity legislation.', 'Evaluar los derechos de los individuos bajo las disposiciones relevantes de la legislación de ciberseguridad actual.', 'Highly advanced', 'Skill', 'AI-Implicit'],
  ['LO4.1.18', 'Lead or contribute to citizen-focused cybersecurity initiatives.', 'Liderar o contribuir a iniciativas de ciberseguridad centradas en el ciudadano.', 'Highly advanced', 'Skill', 'AI-Implicit'],
  ['LO4.1.19', 'Support others to build their capabilities in protecting their devices and their contents against digital threats.', 'Apoyar a otros para desarrollar sus capacidades en la protección de sus dispositivos y contenidos contra amenazas digitales.', 'Highly advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO4.2.03', 'Identify risks of sharing personal data in digital environments, including specific risks in relation to AI systems.', 'Identificar riesgos de compartir datos personales en entornos digitales, incluidos riesgos específicos en relación con los sistemas de IA.', 'Basic', 'Knowledge', 'AI-Explicit'],
  ...
  ['LO4.2.05', 'Recognise that manipulative methods can be used to deceive individuals into providing access to personal data, accounts or other sensitive information.', 'Reconocer que se pueden utilizar métodos manipuladores para engañar a las personas para que proporcionen acceso a datos personales, cuentas u otra información confidencial.', 'Basic', 'Knowledge', 'AI not Implicit or Explicit'],
  ...
  ['LO4.2.08', 'Implement basic security measures for online payments and transactions.', 'Implementar medidas de seguridad básicas para pagos y transacciones en línea.', 'Basic', 'Skill', 'AI not Implicit or Explicit'],
  ['LO4.2.09', 'Respond appropriately to signs of identity theft.', 'Responder apropiadamente a los signos de robo de identidad.', 'Basic', 'Skill', 'AI not Implicit or Explicit'],
  ...
  ['LO4.2.11', 'Acknowledge the importance of careful handling of personal data of oneself and others, especially vulnerable individuals and children.', 'Reconocer la importancia del manejo cuidadoso de los datos personales propios y de otros, especialmente de personas vulnerables y niños.', 'Intermediate', 'Attitude', 'AI not Implicit or Explicit'],
  ['LO4.2.12', 'Recognise key concepts of data protection and privacy legislation including privacy, anonymisation, pseudonymisation and data removal rights.', 'Reconocer conceptos clave de la legislación de protección de datos y privacidad, incluyendo privacidad, anonimización, seudonimización y derechos de eliminación de datos.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO4.2.14', 'Define main privacy statement concepts such as data subject, retention period, data transfer, and automated decision-making system.', 'Definir conceptos principales de declaraciones de privacidad como sujeto de datos, período de retención, transferencia de datos y sistema de toma de decisiones automatizada.', 'Intermediate', 'Knowledge', 'AI not Implicit or Explicit'],
  ...
  ['LO4.2.19', 'Define main features and functions of privacy tools.', 'Definir características y funciones principales de las herramientas de privacidad.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ['LO4.2.20', 'Manage personal data and privacy across a variety of digital environments, including use of privacy tools.', 'Gestionar datos personales y privacidad a través de una variedad de entornos digitales, incluido el uso de herramientas de privacidad.', 'Intermediate', 'Skill', 'AI-Implicit'],
  ['LO4.2.21', 'Continually explore data ownership and privacy issues in relation to digital technological developments.', 'Explorar continuamente cuestiones de propiedad de datos y privacidad en relación con desarrollos tecnológicos digitales.', 'Advanced', 'Attitude', 'AI-Implicit'],
  ...
  ['LO4.2.25', 'Advise on policy or regulatory aspects of data protection and privacy in digital contexts.', 'Aconsejar sobre aspectos políticos o regulatorios de la protección de datos y privacidad en contextos digitales.', 'Highly advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO4.3.03', 'Identify main risks and benefits to physical, mental and social wellbeing in digital environments.', 'Identificar principales riesgos y beneficios para el bienestar físico, mental y social en entornos digitales.', 'Basic', 'Knowledge', 'AI-Implicit'],
  ['LO4.3.04', 'Recognise that there is a variety of information, groups and communities in digital environments that can support one’s physical, mental and/or social wellbeing.', 'Reconocer que existe una variedad de información, grupos y comunidades en entornos digitales que pueden apoyar el bienestar físico, mental y/o social de uno.', 'Basic', 'Knowledge', 'AI-Implicit'],
  ['LO4.3.05', 'Recognise risks and benefits to one\'s own physical, mental and social wellbeing in digital environments.', 'Reconocer riesgos y beneficios para el propio bienestar físico, mental y social en entornos digitales.', 'Basic', 'Knowledge', 'AI-Implicit'],
  ['LO4.3.06', 'Identify features of digital platforms or services, such as social media, that are designed to capture and maintain individuals\' attention.', 'Identificar características de plataformas o servicios digitales, como redes sociales, que están diseñadas para captar y mantener la atención de los individuos.', 'Basic', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO4.3.11', 'Make a basic assessment of one\'s digital habits in relation to one’s physical, mental and social wellbeing.', 'Realizar una evaluación básica de los propios hábitos digitales en relación con el bienestar físico, mental y social.', 'Basic', 'Skill', 'AI not Implicit or Explicit'],
  ...
  ['LO4.3.13', 'Acknowledge the importance of one\'s own and others\' right to disconnect.', 'Reconocer la importancia del derecho propio y ajeno a desconectar.', 'Intermediate', 'Attitude', 'AI not Implicit or Explicit'],
  ['LO4.3.14', 'Acknowledge the physical, mental and social benefits of analysing one\'s own digital usage patterns.', 'Reconocer los beneficios físicos, mentales y sociales de analizar los propios patrones de uso digital.', 'Intermediate', 'Attitude', 'AI not Implicit or Explicit'],
  ['LO4.3.15', 'Identify reliable sources of information, and inclusive groups and communities in digital environments, that can support one’s physical, mental and/or social wellbeing.', 'Identificar fuentes confiables de información, y grupos y comunidades inclusivos en entornos digitales, que puedan apoyar el bienestar físico, mental y/o social de uno.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO4.3.17', 'Describe ways in which some applications of digital technologies, such as social media, augment and perpetuate bias, stereotyping and exclusion.', 'Describir formas en que algunas aplicaciones de tecnologías digitales, como las redes sociales, aumentan y perpetúan el sesgo, los estereotipos y la exclusión.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ['LO4.3.18', 'Describe strategies to help protect against and respond effectively to harmful behaviour and content.', 'Describir estrategias para ayudar a protegerse y responder eficazmente al comportamiento y contenido dañino.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO4.3.20', 'Describe impacts of harmful behaviour, content and deceptive design in digital environments on oneself and others.', 'Describir impactos de comportamiento dañino, contenido y diseño engañoso en entornos digitales sobre uno mismo y otros.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ['LO4.3.21', 'Analyse and adapt one\'s own digital usage patterns to support physical, mental and social wellbeing.', 'Analizar y adaptar los propios patrones de uso digital para apoyar el bienestar físico, mental y social.', 'Intermediate', 'Skill', 'AI not Implicit or Explicit'],
  ['LO4.3.22', 'Implement strategies to help protect oneself against and respond effectively to harmful behaviour and content.', 'Implementar estrategias para ayudar a protegerse y responder eficazmente al comportamiento y contenido dañino.', 'Intermediate', 'Skill', 'AI not Implicit or Explicit'],
  ['LO4.3.23', 'Adapt to changing digital technological developments and needs to support and maintain one\'s own and others\' physical, mental and social wellbeing.', 'Adaptarse a los cambiantes desarrollos tecnológicos digitales y necesidades para apoyar y mantener el bienestar físico, mental y social propio y de otros.', 'Advanced', 'Attitude', 'AI-Implicit'],
  ['LO4.3.24', 'Continually scrutinise the role of digital technologies such as social media in augmenting and perpetuating bias, stereotyping and exclusion.', 'Escrutar continuamente el papel de las tecnologías digitales como las redes sociales en aumentar y perpetuar el sesgo, los estereotipos y la exclusión.', 'Advanced', 'Attitude', 'AI-Implicit'],
  ...
  ['LO4.3.26', 'Flag or intervene effectively in instances of harmful behaviour or content in digital environments.', 'Marcar o intervenir eficazmente en instancias de comportamiento o contenido dañino en entornos digitales.', 'Advanced', 'Skill', 'AI-Implicit'],
  ['LO4.3.27', 'Help others to build capacity to counteract the role of digital technologies such as social media in augmenting and perpetuating bias, stereotyping and exclusion.', 'Ayudar a otros a desarrollar capacidad para contrarrestar el papel de las tecnologías digitales como las redes sociales en aumentar y perpetuar el sesgo, los estereotipos y la exclusión.', 'Advanced', 'Skill', 'AI-Implicit'],
  ['LO4.3.28', 'Assist others to understand their rights in relation to wellbeing and/or inclusion in digital environments.', 'Ayudar a otros a comprender sus derechos en relación con el bienestar y/o la inclusión en entornos digitales.', 'Advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO4.3.31', 'Assess and evaluate evidence on wellbeing and/or inclusion in digital environments to guide decision making.', 'Evaluar y valorar evidencia sobre bienestar y/o inclusión en entornos digitales para guiar la toma de decisiones.', 'Highly advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO4.3.33', 'Contribute to legal and regulatory decision-making in relation to individuals\' wellbeing and/or inclusion in digital environments.', 'Contribuir a la toma de decisiones legales y regulatorias en relación con el bienestar y/o inclusión de los individuos en entornos digitales.', 'Highly advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO4.4.05', 'Identify simple strategies to reduce energy and data consumption of digital technologies, such as minimising usage of energy-intensive applications and non-usage of digital technologies when not needed.', 'Identificar estrategias simples para reducir el consumo de energía y datos de tecnologías digitales, como minimizar el uso de aplicaciones intensivas en energía y no usar tecnologías digitales cuando no se necesiten.', 'Basic', 'Knowledge', 'AI-Implicit'],
  ['LO4.4.06', 'Apply simple strategies to reduce energy and data consumption of digital technologies, such as minimising usage of energy-intensive applications and non-usage of digital technologies when not needed.', 'Aplicar estrategias simples para reducir el consumo de energía y datos de tecnologías digitales, como minimizar el uso de aplicaciones intensivas en energía y no usar tecnologías digitales cuando no se necesiten.', 'Basic', 'Skill', 'AI-Implicit'],
  ...
  ['LO4.4.11', 'Define the concepts of sharing economy and circular economy, including risks, limitations and potential environmental benefits.', 'Definir los conceptos de economía colaborativa y economía circular, incluidos riesgos, limitaciones y posibles beneficios ambientales.', 'Intermediate', 'Knowledge', 'AI not Implicit or Explicit'],
  ['LO4.4.12', 'Apply a variety of strategies to reduce the environmental impact of one\'s use of digital technologies and digital devices, such as informed digital device purchasing decisions, device recycling and repair, environmentally conscious e-commerce practices, and environmentally conscious usage patterns.', 'Aplicar una variedad de estrategias para reducir el impacto ambiental del uso propio de tecnologías y dispositivos digitales, como decisiones informadas de compra, reciclaje y reparación, prácticas de comercio electrónico conscientes del medio ambiente y patrones de uso conscientes.', 'Intermediate', 'Skill', 'AI-Implicit'],
  ['LO4.4.13', 'Stay informed about the environmental impacts of digital technologies and ways in which digital technologies can support sustainability.', 'Mantenerse informado sobre los impactos ambientales de las tecnologías digitales y formas en que las tecnologías digitales pueden apoyar la sostenibilidad.', 'Advanced', 'Attitude', 'AI-Implicit'],
  ['LO4.4.14', 'Evaluate the environmental impacts of digital technologies and infrastructures to support decision-making or advocacy.', 'Evaluar los impactos ambientales de tecnologías e infraestructuras digitales para apoyar la toma de decisiones o la defensa.', 'Advanced', 'Skill', 'AI-Implicit'],
  ['LO4.4.15', 'Help others to assess their use of digital technologies to identify ways in which to reduce environmental impact.', 'Ayudar a otros a evaluar su uso de tecnologías digitales para identificar formas en las que reducir el impacto ambiental.', 'Advanced', 'Skill', 'AI-Implicit'],
  ['LO4.4.16', 'Stay informed about the environmental and sustainability implications of digital technologies across a range of sectors.', 'Mantenerse informado sobre las implicaciones ambientales y de sostenibilidad de las tecnologías digitales en una variedad de sectores.', 'Highly advanced', 'Attitude', 'AI-Implicit'],
  ...
  ['LO4.4.19', 'Contribute to improvements in or solutions for digital sustainability.', 'Contribuir a mejoras o soluciones para la sostenibilidad digital.', 'Highly advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO5.1.08', 'Acknowledge the benefits of building capacity and autonomy in addressing technical issues.', 'Reconocer los beneficios de construir capacidad y autonomía para abordar problemas técnicos.', 'Intermediate', 'Attitude', 'AI not Implicit or Explicit'],
  ['LO5.1.09', 'Troubleshoot technical problems in digital environments using a variety of search and problem-solving strategies (whether human-assisted or digital technology-assisted).', 'Solucionar problemas técnicos en entornos digitales utilizando una variedad de estrategias de búsqueda y resolución de problemas (ya sea asistida por humanos o por tecnología digital).', 'Intermediate', 'Skill', 'AI-Implicit'],
  ...
  ['LO5.1.11', 'Prioritise the development of one\'s capacity to diagnose and solve technical issues in digital environments.', 'Priorizar el desarrollo de la propia capacidad para diagnosticar y resolver problemas técnicos en entornos digitales.', 'Advanced', 'Attitude', 'AI not Implicit or Explicit'],
  ...
  ['LO5.1.13', 'Use various solution-finding strategies to troubleshoot complex technical problems in digital environments.', 'Utilizar varias estrategias de búsqueda de soluciones para solucionar problemas técnicos complejos en entornos digitales.', 'Advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO5.1.15', 'Design or deliver training to support the use of digital devices or systems.', 'Diseñar o impartir capacitación para apoyar el uso de dispositivos o sistemas digitales.', 'Highly advanced', 'Skill', 'AI-Implicit'],
  
  // 5.2 Identifying needs and digital technological responses
  ['LO5.2.01', 'Acknowledge the importance of individual choice in digital environment configurations.', 'Reconocer la importancia de la elección individual en configuraciones de entornos digitales.', 'Basic', 'Attitude', 'AI not Implicit or Explicit'],
  ['LO5.2.02', 'Recognise common ways in which features of digital environments can be adjusted to meet users\' needs and preferences.', 'Reconocer formas comunes en las que las características de los entornos digitales se pueden ajustar para satisfacer las necesidades y preferencias de los usuarios.', 'Basic', 'Knowledge', 'AI not Implicit or Explicit'],
  ...
  ['LO5.2.06', 'Use assistive technologies, if and as required.', 'Utilizar tecnologías de asistencia, si y según sea necesario.', 'Basic', 'Skill', 'AI-Implicit'],
  ['LO5.2.07', 'Use digital assistance tools to support simple tasks, with awareness of their benefits and limitations.', 'Utilizar herramientas de asistencia digital para apoyar tareas simples, con conciencia de sus beneficios y limitaciones.', 'Basic', 'Skill', 'AI-Implicit'],
  ['LO5.2.08', 'Acknowledge the benefits of exploring adaptations to digital environment configurations and features of digital assistance tools.', 'Reconocer los beneficios de explorar adaptaciones a configuraciones de entornos digitales y características de herramientas de asistencia digital.', 'Intermediate', 'Attitude', 'AI-Implicit'],
  ['LO5.2.09', 'Adjust features of one\'s digital environment to suit one\'s own and others\' needs and preferences.', 'Ajustar características del propio entorno digital para adaptarse a las necesidades y preferencias propias y de otros.', 'Intermediate', 'Skill', 'AI-Implicit'],
  ['LO5.2.10', 'Make informed use of digital assistance tools to support one\'s own and others\' needs, with awareness of their benefits and limitations.', 'Hacer un uso informado de herramientas de asistencia digital para apoyar las necesidades propias y de otros, con conciencia de sus beneficios y limitaciones.', 'Intermediate', 'Skill', 'AI-Implicit'],
  ['LO5.2.11', 'Prioritise an ongoing assessment of how digital environmental configurations, digital assistance tools and/or assistive technologies can meet the needs of oneself and others.', 'Priorizar una evaluación continua de cómo las configuraciones ambientales digitales, las herramientas de asistencia digital y/o las tecnologías de asistencia pueden satisfacer las necesidades propias y de otros.', 'Advanced', 'Attitude', 'AI-Implicit'],
  ['LO5.2.12', 'Adjust features of one\'s digital environment to suit one\'s own and others\' needs and preferences.', 'Ajustar características del propio entorno digital para adaptarse a las necesidades y preferencias propias y de otros.', 'Advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO5.2.14', 'Support others to make informed use of digital assistance tools, and adjustments to digital environment configurations, to meet their own and others\' needs.', 'Apoyar a otros para hacer un uso informado de herramientas de asistencia digital y ajustes a configuraciones de entornos digitales, para satisfacer sus propias necesidades y las de otros.', 'Advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO5.3.05', 'Define the concept of human-centric and its role in digital technologies development and usage.', 'Definir el concepto de centrado en el ser humano y su papel en el desarrollo y uso de tecnologías digitales.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ['LO5.3.06', 'Identify examples of the interplay between humans and digital technologies in creativity and problem solving.', 'Identificar ejemplos de la interacción entre humanos y tecnologías digitales en creatividad y resolución de problemas.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO5.3.08', 'Assess strengths and weaknesses of available digital technologies in relation to a particular problem-solving task.', 'Evaluar fortalezas y debilidades de tecnologías digitales disponibles en relación con una tarea de resolución de problemas particular.', 'Intermediate', 'Skill', 'AI-Implicit'],
  ...
  ['LO5.3.10', 'Prioritise human-centric approaches in one\'s own use of digital technologies for problem-solving.', 'Priorizar enfoques centrados en el ser humano en el propio uso de tecnologías digitales para la resolución de problemas.', 'Advanced', 'Attitude', 'AI-Implicit'],
  ...
  ['LO5.3.12', 'Contribute to initiatives focused on the application of digital technologies to help solve complex problem solving tasks.', 'Contribuir a iniciativas centradas en la aplicación de tecnologías digitales para ayudar a resolver tareas complejas de resolución de problemas.', 'Advanced', 'Skill', 'AI-Implicit'],
  ...
  ['LO5.4.02', 'Acknowledge the benefits and commonplace nature of seeking support in addressing digital competence needs.', 'Reconocer los beneficios y la naturaleza común de buscar apoyo para abordar las necesidades de competencia digital.', 'Basic', 'Attitude', 'AI not Implicit or Explicit'],
  ...
  ['LO5.4.04', 'Recognise that digital competence requires regular updating for daily life, working and learning.', 'Reconocer que la competencia digital requiere una actualización regular para la vida diaria, el trabajo y el aprendizaje.', 'Basic', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO5.4.06', 'Acknowledge the benefits of staying informed about developments in digital technologies.', 'Reconocer los beneficios de mantenerse informado sobre los desarrollos en tecnologías digitales.', 'Intermediate', 'Attitude', 'AI-Implicit'],
  ...
  ['LO5.4.08', 'Identify relevant learning to meet one\'s digital competence needs.', 'Identificar el aprendizaje relevante para satisfacer las propias necesidades de competencia digital.', 'Intermediate', 'Knowledge', 'AI-Implicit'],
  ...
  ['LO5.4.12', 'Engage in ongoing self-development to meet digital competence needs.', 'Participar en el autodesarrollo continuo para satisfacer las necesidades de competencia digital.', 'Advanced', 'Attitude', 'AI-Implicit'],
  ...
  ['LO5.4.14', 'Compile available digital competence learning opportunities for a particular purpose.', 'Recopilar oportunidades de aprendizaje de competencia digital disponibles para un propósito particular.', 'Advanced', 'Skill', 'AI-Implicit'],
  ['LO5.4.15', 'Engage in ongoing self-development to meet complex or specialised digital competence needs.', 'Participar en el autodesarrollo continuo para satisfacer necesidades de competencia digital complejas o especializadas.', 'Highly advanced', 'Attitude', 'AI-Implicit'],
  ['LO5.4.16', 'Mentor others in identifying and addressing their digital competence needs.', 'Mentorear a otros en la identificación y tratamiento de sus necesidades de competencia digital.', 'Highly advanced', 'Skill', 'AI-Implicit'],
